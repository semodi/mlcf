...
elf = get_elf(atoms, Density(*siesta.get_data('./test/0.RHOXC')), basis)
...
def test_elfcs():
    ...
    for i in [1,4,0]:
        ...
        angles1 = get_elfcs_angles(elf[i], i, atoms.get_positions())
        rotated1 = rotate_tensor(elf[i], angles1, inverse = True)
        ...
        for it in range(5):
            ...
            angles2 = get_elfcs_angles(elf_rotated, i, coords_rotated)
            rotated2 = rotate_tensor(elf_rotated, angles2, inverse = True)
