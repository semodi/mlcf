...
from siestah2o import single_thread_descriptors_molecular
import numpy as np
...
#    h2o = read('start.traj')
    ...
    scaler_o = pickle.load(open(model_path + 'scaler_O_mol','rb'))
    scaler_h = pickle.load(open(model_path + 'scaler_H_mol','rb'))
    ...
    krr_o = keras.models.load_model(model_path + 'force_O_mol')
    krr_h = keras.models.load_model(model_path + 'force_H_mol')
    h2o.calc.set_force_model(krr_o, krr_h)
    h2o.calc.set_nn_path('/gpfs/home/smdick/exchange_ml/models/new/qz_mbp/energy_qz_mbp_mol/') 
    f_model_found = True
